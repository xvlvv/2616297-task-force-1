...
readonly final class ViewUserDTO
{
     ...
     * @param string|null $description Описание пользователя
     * @param string|null $bio Биография
     * @param array|null $specializations Массив специализаций
     ...
     * @param string|null $telegramUsername Имя пользователя в Telegram
